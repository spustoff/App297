...
class AppDelegate: NSObject, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        Apphud.start(apiKey: "app_Y3zK9hC2VAtbpPFjTnDeHAy2wGa7Bp")
        
        OneSignal.initialize("27fa812c-063e-4177-a374-0ee91e09fb71", withLaunchOptions: launchOptions)
        Amplitude.instance().initializeApiKey("003d348415715186af82ffd12b214a59")
